...
function App() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Thank you for your inquiry! Our team will reach out to you within 24 hours.");
          ...
          <div className="bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-slate-100">
            ...
            <div className="lg:w-3/5 p-10 lg:p-14">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  type="submit"
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-4 px-8 rounded-xl transition-colors shadow-lg shadow-blue-500/30 flex justify-center items-center gap-2"
                >
                  Submit Inquiry
